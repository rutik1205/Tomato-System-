    ...
    if uploaded_file:
        ...
        try:
            ...
            if predicted_class == "No_tomato_leaf" :
                ...
                # Recommended Near Pesticide Shop
                if st.button ( t["btn"] ) :
                    ...
                    try :
                        ...
                        postal = loc.get ( "postal", "N/A" )

                        st.info (f'{t["location"]}: {city}, {region}, {country} - {postal}')
                    ...
                    google_maps_url = (
                        ...
                        f"pesticide+shop/@{lat},{lon},14z"
                    )

                    st.success ( t["success1"] )
                    st.link_button ( t["open_map"], google_maps_url )
